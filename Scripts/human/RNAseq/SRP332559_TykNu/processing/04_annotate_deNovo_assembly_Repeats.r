...
library(rtracklayer)
#load data
anno <-  import.gff2("/omics/groups/OE0219/internal/tinat/210920_SRP332559_processing_deNovo/gffCompare_SRP332559_mergedTranscripts.annotated.sorted.gtf")
...
saveRDS(anno,"/omics/groups/OE0219/internal/tinat/210920_SRP332559_processing_deNovo/gffCompare.annotated.sorted_repeat_anno.rds" )