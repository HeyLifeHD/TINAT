...
library(rtracklayer)
#load data
anno <-  import.gff2("/omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_deNovo/all_celllines/gffCompare_T98G.annotated.sorted.gtf")
...
saveRDS(anno,"/omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_deNovo/all_celllines/gffCompare_T98G.annotated.sorted_repeat_anno.rds" )
