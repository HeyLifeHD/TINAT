...
output.dir <- "/omics/groups/OE0219/internal/tinat/integration/peptidomics_AML/comparison_gene_expression/MHCII"
...
#peptidomics list
peptides <- as.data.frame(readxl::read_excel("/omics/groups/OE0219/internal/tinat/integration/peptidomics_AML/data/AML205_218_ORF_database_II.xlsx", sheet=1))
peptides[, 23:37] <- NULL
#Set specifications
