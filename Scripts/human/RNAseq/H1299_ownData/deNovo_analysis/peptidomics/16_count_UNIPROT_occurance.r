...
pdf(file.path(output.dir, "2of3DACSB_unique", "number_of_mismatches_uniprot.pdf"), height=5, width=5)
gghistogram(number_of_MM_long,fill="gray",x= "Number_of_matches_with_UNIPROT" , facet.by="Number_of_mismatches_allowed", bins=50)
dev.off()
