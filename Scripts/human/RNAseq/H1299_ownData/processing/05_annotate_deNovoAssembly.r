...
library(rtracklayer)
#load data
anno <-  import.gff2("/omics/groups/OE0219/internal/tinat/210726_shortRead_processing_deNovo_custom4/gffCompare.annotated.sorted.gtf")
...
dist_N <- distanceToNearest(resize(anno,1), repeats, ignore.strand=FALSE)
...
dist_N <- distanceToNearest(resize(anno,1), repeats_sub, ignore.strand=FALSE)
