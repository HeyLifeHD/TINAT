...
#run processing
mkdir /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/ 
cd /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/ 
...
/omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/project_specific.config
nano /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/project_specific.config
#run pipeline
cd /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef
/omics/groups/OE0219/internal/nextflow/nextflow \
-c   /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/project_specific.config \
run /omics/groups/OE0219/internal/nextflow/rnaseq-master/main.nf  \
--outdir /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/ \
...
for file in `ls /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/HISAT2/aligned_sorted/*.bam`;do
    ...
    bamCoverage -b $file \
        -o /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/bigwig/${name}.bw \
        -p 15
    echo $name
done
...
for file in `ls /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/HISAT2/aligned_sorted/*.bam`;do
    ...
    name=`basename $pathname`
    bamCoverage -b $file \
        -o /omics/groups/OE0219/internal/tinat/210712_shortRead_processing_knownRef/bigwig/${name}.normalized.bw \
