...
dir.create(file.path(PostDE.dir,"comparison","2lfc"))
dir.create(file.path(PostDE.dir, "comparison","2lfc", "transcripts"))
pdf(file.path(PostDE.dir,"comparison","2lfc", "transcripts", "comparison_DEG_subsets.pdf"), width=8, height=4)
...
dir.create(file.path(PostDE.dir,"comparison"))
dir.create(file.path(PostDE.dir,"comparison","2lfc"))
dir.create(file.path(PostDE.dir, "comparison","2lfc", "ORFs"))
pdf(file.path(PostDE.dir,"comparison","2lfc", "ORFs", "comparison_ORFs_subsets.pdf"), width=8, height=4)
upset(fromList(DEG_list_peptides_names), order.by = "freq", set_size.show = TRUE)
dev.off()
...
for(i in names(DEG_list_peptides)){
    ...
    pdf(file.path(PostDE.dir,"comparison","2lfc", "ORFs", paste0("histo_aminoacidLength_", i, ".pdf")))
...
for(i in names(DEG_list_peptides)){
    size <- width(DEG_list_peptides[[i]])
    pdf(file.path(PostDE.dir,"comparison","2lfc", "ORFs", paste0("histo_aminoacidLength_", i, "_log2Scale.pdf")))
...
for(i in names(DEG_list_peptides)){
    ...
    size[[i]]$set <- i
    pdf(file.path(PostDE.dir,"comparison","2lfc", "ORFs", paste0("scatter_aminoacidLength_", i, "_log2Scale.pdf")))
...
pdf(file.path(PostDE.dir,"comparison",,"2lfc" "ORFs", paste0("scatter_aminoacidLength_", "combined", ".pdf")),width=10)
ggscatter(size_ul, x="Var1", y="Freq", col="set",ylab="Number of ORFs",xlab="ORF length [aminoacids]", legend="right")
dev.off()
pdf(file.path(PostDE.dir,"comparison","2lfc", "ORFs", paste0("scatter_aminoacidLength_", "combined", "_log2Scale.pdf")),width=10)
...
size_ul <-do.call("rbind", size)
pdf(file.path(PostDE.dir,"comparison","2lfc", "ORFs", paste0("scatter_aminoacidLength_", "combined_normalized", ".pdf")),width=10)
ggscatter(size_ul, x="Var1", y="Freq_norm", col="set",ylab="Normalized number of ORFs",xlab="ORF length [aminoacids]", legend="right")
dev.off()

pdf(file.path(PostDE.dir,"comparison","2lfc", "ORFs", paste0("scatter_aminoacidLength_", "combined_normalized", "_log2Scale.pdf")),width=10)
