...
library(Biostrings)
peptide <- readAAStringSet("/omics/groups/OE0219/internal/tinat/220316_cellline_deNovo_assembly/transdecoder_default_topStrand_8aa/longest_orfs.pep")
...
head(names(peptide_sub))
head(peptide_sub)

writeXStringSet(peptide_sub, "/omics/groups/OE0219/internal/tinat/220316_cellline_deNovo_assembly/transdecoder_default_topStrand_8aa/longest_orfs_validated_forJens_novel.fa")
#peptide_sub <-  readAAStringSet("/omics/groups/OE0219/internal/tinat/220316_cellline_deNovo_assembly/transdecoder_default_topStrand_8aa/longest_orfs_validated_forJens_novel.fa")

##select ORFs baased on upregulation in DEG analysis
DEG_results_list<- readRDS("/omics/groups/OE0219/internal/tinat/Cellline_panel/220319_cellline_deNovo_assembly_quantification_analysis//results/PostDE/DEG_results_group_list.rds")
induced_genes <- DEG_results_list$DACSB_vs_DMSO[which(DEG_results_list$DACSB_vs_DMSO$padj < 0.01 & DEG_results_list$DACSB_vs_DMSO$log2FoldChange>2),]
...
# writeXStringSet(pepteide_sub_induced, "/omics/groups/OE0219/internal/tinat/220316_cellline_deNovo_assembly/transdecoder_default_topStrand_8aa/longest_orfs_validated_induced_DACSBvsDMSO_novelTranscript_forJens_novel.fa")
...
# length(peptide_sub)
# writeXStringSet(pepteide_sub_candidates, "/omics/groups/OE0219/internal/tinat/220316_cellline_deNovo_assembly/transdecoder_default_topStrand_8aa/longest_orfs_validated_candidate_transcript_forJens_novel.fa")
# #all novel ORFs
# pepteide_sub_novelORFs <- peptide_sub[temp %in% peptides_new_ORF$accession_new,]
# length(pepteide_sub_novelORFs)
# length(peptide_sub)
# writeXStringSet(pepteide_sub_novelORFs, "/omics/groups/OE0219/internal/tinat/220316_cellline_deNovo_assembly/transdecoder_default_topStrand_8aa/longest_orfs_novelORFs_identified_transcript_forJens_novel.fa")
