...
#run processing
mkdir /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/ 
...
cp /omics/groups/OE0219/internal/repguide/201207_lsRNAseq_processing_hg19_incl_gRNAseq/project_specific.config \
/omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/project_specific.config
nano /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/project_specific.config
#run pipeline
cd /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef
/icgc/dkfzlsdf/analysis/C010/nextflow/nextflow \
-c   /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/project_specific.config \
run /icgc/dkfzlsdf/analysis/C010/nextflow/rnaseq-master/main.nf  \
--outdir /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/ \
--singleEnd --genome Hg19 \
...
mkdir /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/bigwig/
for file in `ls /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/HISAT2/aligned_sorted/*.bam`;do
    pathname="${file%.*}"
    name=`basename $pathname`
    bamCoverage -b $file \
        -o /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/bigwig/${name}.bw \
        -p 15
    echo $name
done
...
cd /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/bigwig/
...
for file in `ls /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/HISAT2/aligned_sorted/*.bam`;do
    ...
    name=`basename $pathname`
    bamCoverage -b $file \
        -o /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/bigwig/${name}_fw.bw \
        -p 15 --filterRNAstrand forward --smoothLength 30 --binSize 10
    bamCoverage -b $file \
        -o /omics/groups/OE0219/internal/tinat/210913_SRP073103_processing_knownRef/bigwig/${name}_rv.bw \
