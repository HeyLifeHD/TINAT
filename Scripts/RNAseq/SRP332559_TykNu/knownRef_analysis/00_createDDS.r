...
library(DESeq2)
#folder
base.dir<- "/omics/groups/OE0219/internal/tinat/210920_SRP332559_knownRef_analysis"
dir.create(base.dir)
...
#load data
counts <- read.table("/omics/groups/OE0219/internal/tinat/210920_SRP332559_processing_knownRef//transcripts/gene_count_matrix.csv", sep=",",  header=TRUE)
