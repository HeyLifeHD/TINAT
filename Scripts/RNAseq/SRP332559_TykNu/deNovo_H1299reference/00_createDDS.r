...
library(DESeq2)
#folder
base.dir<- "/omics/groups/OE0219/internal/tinat/211007_SRP332559_deNovo_H1299Ref_analysis"
...
#load data
counts <- read.table("/omics/groups/OE0219/internal/tinat/210929_SRP332559_deNovo_quantification_H1299Ref/transcripts/transcript_count_matrix.csv", sep=",",  header=TRUE)
