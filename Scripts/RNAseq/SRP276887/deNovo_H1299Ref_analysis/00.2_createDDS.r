...
#load data
counts <- read.table("/omics/groups/OE0219/internal/tinat/220118_SRP276887_deNovo_quantification_H12Ref/transcripts/transcript_count_matrix.csv", sep=",",  header=TRUE)
